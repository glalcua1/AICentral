  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow': '0 0 0 1px rgba(14, 165, 233, 0.1), 0 4px 16px rgba(14, 165, 233, 0.12)',
        'glow-lg': '0 0 0 1px rgba(14, 165, 233, 0.15), 0 8px 32px rgba(14, 165, 233, 0.18)',
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-conic': 'conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))',
        'mesh-gradient': 'linear-gradient(45deg, #0ea5e9 0%, #3b82f6 25%, #6366f1 50%, #8b5cf6 75%, #a855f7 100%)',
      },
    },
  },
  plugins: [
